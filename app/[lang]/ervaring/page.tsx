...
export default async function ErvaringPage({ params }: { params: Promise<{ lang: Language }> }) {
  const { lang } = await params;
  const t = getTranslations(lang);
  ...
  const experiences = [
    ...
    },
    {
      ...
      achievements: [
        lang === 'nl' ? "Lead consultant CSM/ITSM implementatie voor Nederlandse IT MSP met complexe integratie van 40+ externe ITSM tools" : lang === 'en' ? "Lead consultant CSM/ITSM implementation for Dutch IT MSP with complex integration of 40+ external ITSM tools" : "Consultant principal implémentation CSM/ITSM pour MSP IT néerlandais avec intégration complexe de plus de 40 outils ITSM externes",
        lang === 'nl' ? "Lead consultant ITSM implementatie voor Belgisch recyclingbedrijf met integraties naar Jira en MS Intune" : lang === 'en' ? "Lead consultant ITSM implementation for Belgian recycling company with integrations to Jira and MS Intune" : "Consultant principal implémentation ITSM pour entreprise de recyclage belge avec intégrations vers Jira et MS Intune",
        lang === 'nl' ? "Functional analyst rol: definiëren van functionele requirements en ondersteuning bij user acceptance testing" : lang === 'en' ? "Functional analyst role: defining functional requirements and supporting user acceptance testing" : "Rôle d'analyste fonctionnel : définition des exigences fonctionnelles et soutien aux tests d'acceptation utilisateur"
      ],
    },
    {
      title: lang === 'nl' ? "Technical Consultant Specialist" : lang === 'en' ? "Technical Consultant Specialist" : "Consultant Technique Spécialiste",
      company: "Plat4Mation",
      location: lang === 'nl' ? "België" : lang === 'en' ? "Belgium" : "Belgique",
      period: lang === 'nl' ? "Februari 2022 - Augustus 2023" : lang === 'en' ? "February 2022 - August 2023" : "Février 2022 - Août 2023",
      description: [
        lang === 'nl'
      ...
      achievements: [
        lang === 'nl' ? "HRSD POC voor Europese Commissie" : lang === 'en' ? "HRSD POC for European Commission" : "POC HRSD pour la Commission européenne",
        lang === 'nl' ? "PPM project voor Delen Private Bank met integratie naar SD Worx" : lang === 'en' ? "PPM project for Delen Private Bank with integration to SD Worx" : "Projet PPM pour Delen Private Bank avec intégration vers SD Worx",
        lang === 'nl' ? "Custom applicaties voor IMEC" : lang === 'en' ? "Custom applications for IMEC" : "Applications sur mesure pour IMEC",
        lang === 'nl' ? "ServiceNow integraties met Salesforce en SAP SF voor BARCO" : lang === 'en' ? "ServiceNow integrations with Salesforce and SAP SF for BARCO" : "Intégrations ServiceNow avec Salesforce et SAP SF pour BARCO",
        lang === 'nl' ? "Technical Lead voor digital workflow project bij Brussels Airport Company" : lang === 'en' ? "Technical Lead for digital workflow project at Brussels Airport Company" : "Lead technique pour le projet de workflow numérique chez Brussels Airport Company"
      ],
    },
    {
      title: lang === 'nl' ? "Project Consultant" : lang === 'en' ? "Project Consultant" : "Consultant Projet",
      company: "TriFinance",
      location: lang === 'nl' ? "België" : lang === 'en' ? "Belgium" : "Belgique",
      period: lang === 'nl' ? "December 2021 - Februari 2022" : lang === 'en' ? "December 2021 - February 2022" : "Décembre 2021 - Février 2022",
      description: [
        lang === 'nl'
      ...
      achievements: [
        lang === 'nl' ? "Succesvolle implementatie van CSM/ITSM/FSM projecten" : lang === 'en' ? "Successful implementation of CSM/ITSM/FSM projects" : "Implémentation réussie de projets CSM/ITSM/FSM",
        lang === 'nl' ? "Projectdocumentatie en technische specificaties opstellen" : lang === 'en' ? "Drafting project documentation and technical specifications" : "Rédaction de la documentation de projet et des spécifications techniques"
      ],
    },
    {
      title: lang === 'nl' ? "ServiceNow Admin/Developer" : lang === 'en' ? "ServiceNow Admin/Developer" : "Administrateur/Développeur ServiceNow",
      company: "HouseofHR",
      location: lang === 'nl' ? "België" : lang === 'en' ? "Belgium" : "Belgique",
      period: lang === 'nl' ? "December 2006 - December 2021" : lang === 'en' ? "December 2006 - December 2021" : "Décembre 2006 - Décembre 2021",
      description: [
        lang === 'nl'
      ...
      achievements: [
        lang === 'nl' ? "Meer dan 15 jaar ervaring met ServiceNow platform" : lang === 'en' ? "More than 15 years of experience with ServiceNow platform" : "Plus de 15 ans d'expérience avec la plateforme ServiceNow",
        lang === 'nl' ? "Succesvolle implementaties van ITSM, FSM, CSM en custom applicaties" : lang === 'en' ? "Successful implementations of ITSM, FSM, CSM and custom applications" : "Implémentations réussies d'ITSM, FSM, CSM et d'applications sur mesure",
        lang === 'nl' ? "Management ervaring met teams van 5 FTE's" : lang === 'en' ? "Management experience with teams of 5 FTE's" : "Expérience de gestion avec des équipes de 5 ETP",
        lang === 'nl' ? "Ontwikkeling van custom integraties met Azure, Jira en MS Intune" : lang === 'en' ? "Development of custom integrations with Azure, Jira and MS Intune" : "Développement d'intégrations sur mesure avec Azure, Jira et MS Intune"
      ],
    },
  ];
  ...
  const certifications = [
    {
      title: lang === 'nl' ? "ServiceNow Certified Implementation Specialist - Hardware Asset Management" : lang === 'en' ? "ServiceNow Certified Implementation Specialist - Hardware Asset Management" : "ServiceNow Certified Implementation Specialist - Hardware Asset Management",
      issuer: "ServiceNow",
      date: lang === 'nl' ? "Sep 2024" : lang === 'en' ? "Sep 2024" : "Sep 2024",
    },
    {
      title: lang === 'nl' ? "ServiceNow Certified Implementation Specialist - Field Service Management" : lang === 'en' ? "ServiceNow Certified Implementation Specialist - Field Service Management" : "ServiceNow Certified Implementation Specialist - Field Service Management",
      issuer: "ServiceNow",
      date: lang === 'nl' ? "Mar 2023" : lang === 'en' ? "Mar 2023" : "Mar 2023",
    },
    {
      title: lang === 'nl' ? "ServiceNow Certified System Administrator (CSA)" : lang === 'en' ? "ServiceNow Certified System Administrator (CSA)" : "ServiceNow Certified System Administrator (CSA)",
      issuer: "ServiceNow",
      date: lang === 'nl' ? "Sep 2018 - Huidig (meerdere Delta certificeringen)" : lang === 'en' ? "Sep 2018 - Current (multiple Delta certifications)" : "Sep 2018 - Actuel (plusieurs certifications Delta)",
    },
    {
      title: lang === 'nl' ? "ServiceNow Certified Implementation Specialist - ITSM (CIS-ITSM)" : lang === 'en' ? "ServiceNow Certified Implementation Specialist - ITSM (CIS-ITSM)" : "ServiceNow Certified Implementation Specialist - ITSM (CIS-ITSM)",
      issuer: "ServiceNow",
      date: "",
    },
    {
      title: lang === 'nl' ? "ServiceNow Certified Implementation Specialist - CSM (CIS-CSM)" : lang === 'en' ? "ServiceNow Certified Implementation Specialist - CSM (CIS-CSM)" : "ServiceNow Certified Implementation Specialist - CSM (CIS-CSM)",
      issuer: "ServiceNow",
      date: "",
    },
    {
      title: lang === 'nl' ? "ServiceNow Platform Subscription Model" : lang === 'en' ? "ServiceNow Platform Subscription Model" : "ServiceNow Platform Subscription Model",
      issuer: lang === 'nl' ? "ServiceNow Micro-Certification" : lang === 'en' ? "ServiceNow Micro-Certification" : "ServiceNow Micro-Certification",
      date: lang === 'nl' ? "Apr 2019" : lang === 'en' ? "Apr 2019" : "Avr 2019",
    },
    {
      title: lang === 'nl' ? "ITIL Foundation V3" : lang === 'en' ? "ITIL Foundation V3" : "ITIL Foundation V3",
      issuer: "EXIN",
      date: lang === 'nl' ? "May 2009" : lang === 'en' ? "May 2009" : "Mai 2009",
    },
    {
      title: lang === 'nl' ? "ServiceDesk Manager" : lang === 'en' ? "ServiceDesk Manager" : "ServiceDesk Manager",
      issuer: lang === 'nl' ? "IIR Nederland" : lang === 'en' ? "IIR Netherlands" : "IIR Pays-Bas",
      date: "",
    },
    {
      title: lang === 'nl' ? "Coaching, Managing and Leading" : lang === 'en' ? "Coaching, Managing and Leading" : "Coaching, Gestion et Leadership",
      issuer: "Krauthammer",
      date: "",
    },
    {
      title: lang === 'nl' ? "People Management" : lang === 'en' ? "People Management" : "Gestion des Personnes",
      issuer: lang === 'nl' ? "Koen Van den Brandt" : lang === 'en' ? "Koen Van den Brandt" : "Koen Van den Brandt",
      date: "",
    },
  ];
